...
# slider(min=0, max=10, value=5, bind=on_slide)
...
#     if sim_steps % 50 == 1:
#         scene.caption = f'<span style="font-size: 20px; color: black; font-weight: bold;">\
# N: {electron_number}  |  Electric Potential Energy: {get_total_electric_potential_energy(electrons):.7}</span>\n'
